                ...
                <table id="datatablesSimple">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-datatable btn-icon btn-transparent-dark me-2"><i class="fas fa-ellipsis-v"></i></button>
                                <button class="btn btn-datatable btn-icon btn-transparent-dark"><i class="far fa-trash-alt"></i></i></button>
                            </td>
                        </tr>
                        <tr>
