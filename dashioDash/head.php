...
<head>
    ...
    <!-- Favicons -->
    <link href="<?= $logoAdmin ?>" rel="icon">
    <link href="<?= $logoAdmin ?>" rel="apple-touch-icon">
...
<body>
    <section id="container">
        ...
        <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="<?= $mainLink ?>" class="logo"><b><span><?= $title ?></span></b></a>
            <!--logo end-->
            <div class="nav notify-row" id="top_menu">
                <!--  notification start -->
                <ul class="nav top-menu">
                    <?php if ($navSettings == true) : ?>
                        <!-- settings start -->
                        <li class="dropdown">
        ...
        <aside>
            <div id="sidebar" class="nav-collapse ">
                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <p class="centered">
                        <img src="<?= $photoUser ?>" class="img-circle" width="80">
                    </p>
